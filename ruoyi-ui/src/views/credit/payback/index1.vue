...
<!--      <el-table-column label="逻辑主键" align="center" prop="id" />-->
      <el-table-column label="信用卡id" align="center" prop="cardId" />
      ...
      <el-table-column label="1是，0否" align="center" prop="isPayed" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="信用卡id" prop="cardId">
          <el-input v-model="form.cardId" placeholder="请输入信用卡id" />
        </el-form-item>
        <el-form-item label="账单月份" prop="month">
        ...
        <el-form-item label="是否还款" prop="isPayed">
          <el-input v-model="form.isPayed" placeholder="请输入1是，0否" />
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        cardId: [
          { required: true, message: "信用卡id不能为空", trigger: "blur" }
        ],
      }
    };
  },
