    ...
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="账单日" prop="billingDay">
        <el-date-picker clearable size="small"
                        v-model="queryParams.billingDay"
                        type="date"
...
<!--      <el-table-column label="逻辑主键" align="center" prop="id"/>-->
      ...
      <el-table-column label="额度" align="center" prop="creditLimit"/>
      <el-table-column label="账单日" align="center" prop="billingDay" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.billingDay, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="还款日" align="center" prop="repaymentDate" width="180">
        <template slot-scope="scope">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['credit:card:edit']">修改
          </el-button>
          <el-button
            size="mini"
            type="text"
            ...
            v-hasPermi="['credit:card:remove']">删除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="额度" prop="creditLimit">
          <el-input v-model="form.creditLimit" placeholder="请输入额度"/>
        </el-form-item>
        <el-form-item label="账单日" prop="billingDay">
          <el-date-picker clearable size="small"
        ...
        <el-form-item label="年费" prop="annualFee">
          <el-input v-model="form.annualFee" placeholder="请输入年费"/>
        </el-form-item>
        <el-form-item label="发卡银行" prop="bank">
...
<script>
  import { addCard, delCard, exportCard, getCard, listCard, updateCard } from '@/api/credit/card'
